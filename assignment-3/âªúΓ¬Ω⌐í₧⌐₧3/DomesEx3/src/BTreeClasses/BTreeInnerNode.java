...
public class BTreeInnerNode<TKey extends Comparable<TKey>> extends BTreeNode<TKey> {
	...
	//public static BPlusTreeMetrics BP_INNER_NODE_METRICS= new BPlusTreeMetrics();
	public int M;
	
	public BTreeInnerNode(int M) {
		super(M);
		this.keys = new Object[M + 1];
		this.children = new Object[M + 2];
		this.M = M;
	}
	...
	protected BTreeNode<TKey> split() {
		...
		BTreeInnerNode<TKey> newRNode = new BTreeInnerNode<TKey>(this.M);
